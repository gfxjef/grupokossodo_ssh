...
from app.database import get_db_connection  # Updated to use central function
...
# Remove the DB_CONFIG and get_db_connection function - they're now in database.py
